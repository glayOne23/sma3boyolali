        ...
        <div class="container">				
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="/">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="/achievement">Prestasi </a> <span class="lnr lnr-arrow-right"></span><a href="/prestasi/{{$achievement->id}} ">{{$achievement->title}}</a></p>
                </div>	
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-8 posts-list">
                    ...
                    <div class="single-post row">
                        <div class="col-lg-12 col-md-12 ">
                            ...
                            <a class="posts-title" href="/achievement/{{$achievement->id}}"> <h3>{{$achievement->title}}</h3></a>
